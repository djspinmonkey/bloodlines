...
class CharacterTest < ActiveSupport::TestCase
  def setup
    ...
    @trait2 = Trait.new(:name => "Strong", :description => "bend bars and stuff", :bonuses => {'strength' => 1})
    @trait3 = Trait.new(:name => "Really Strong", :description => "bend bars and stuff... a lot!", :bonuses => {'strength' => 5})
